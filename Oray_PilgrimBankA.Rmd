...
t.test(sub_tenure_profit[sub_tenure_profit$subscription_grp == "1",]$Profit,
       sub_tenure_profit[sub_tenure_profit$subscription_grp == "3",]$Profit,
       paired=FALSE)
...
In the above histogram, we took a sample of the data set profitability (10,000). The visualization shows a right skew, meaning that the majority of the profitability hovers around zero, which corroborates with Green's findings that the majority of profit came from a small number of customers.

We then decided to take the mean of another profitability sample, which resulted in a normal distribution. 
