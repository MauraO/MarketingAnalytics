...
In the above histogram, we took a sample of the data set profitability (10,000). The visualization shows a right skew, meaning that the majority of the profitability hovers around zero, which corrorborates with Green's findings that the majority of profit came from a small number of customers.
