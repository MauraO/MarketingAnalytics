...
Thus, he has a sample set of 30,000 customers and he knows the average profitability of customer who use and who do not use online banking. His task is to analyze the data and conclude which is correct for the whole customer data of 5 million.
...
```
As was shown in part 2, all variables were originally stored as numeric. Changing variables such as Online, Age, Income and District to factors will make for easier analysis. We also decided to use "0" as the NA category for both Age and Income.
