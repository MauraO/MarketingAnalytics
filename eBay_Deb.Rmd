...
# Treatment Period for 0 which means both the groups were shown the ads starting on 04/01/2012
# Treatment Period for 1 which means control group was shown the ads and treatment group wasnt shown the ads  # starting  05/22/2012

```
Firstly, we decided to convert the Treatment Period and Treatment Group variables from integers to factors, because the variables are essentially categorical. Converting to factors will make for better statistical analysis and regression.
